...
from models.ARPNet import FewShotSeg
...
def main(_run, _config, _log):
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            #query_pred, align_loss, mse_loss, qry_loss = model(support_images, support_fg_mask, query_images,query_labels, train=True)
            query_pred, align_loss, qry_loss,mse_loss = model(support_images, support_fg_mask, query_images,
                                                               query_labels, train=True)
            ...
            loss = query_loss + align_loss + qry_loss+mse_loss
